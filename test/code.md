...
latynka2020/combining_acute_accent
...
<span class='ques'>?</span> **svyatoí** (святої) чи **tvoi** (твої)...
...
Пом'якшуваний апостроф в деяких випадках можна опускати <span class='ques'>?</span> (як `ё` = `е` у російській мові). Наприклад:
